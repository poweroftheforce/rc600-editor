...
//   function sendCC(cc, value = 127, channel = 0) {
//     if (!midiOut) return;
//     midiOut.send([0xB0 | channel, cc, value]);
//   }
...
//   function trigger(cc) {
//     midiOut.send([0xB0, cc, 127]);
//     setTimeout(() => midiOut.send([0xB0, cc, 0]), 10);
//   }
...
//             <h2 className="text-lg font-semibold mb-4">Global Controls</h2>
//             <div className="grid grid-cols-2 gap-4">
//               <button onClick={() => sendCC(86)} className="py-2 bg-red-700 rounded-xl">ALL STOP</button>
//               <button onClick={() => sendCC(93)} className="py-2 bg-yellow-600 rounded-xl">UNDO / REDO</button>
//               <button onClick={() => { sendCC(94); setTimeout(() => sendCC(94, 0), 10); }} className="py-2 bg-purple-600 rounded-xl">RHYTHM</button>
//               <button onClick={() => loadMemory(1)} className="py-2 bg-blue-700 rounded-xl">LOAD MEM 1</button>
//             </div>
//           </div>
...
// // // export default { RC600Controller as App };